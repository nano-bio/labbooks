...
import snowball.models as models
from snowball.admin import PlotAdmin
import time
...
def showmeasurement(request, id):
    ...
    data = PlotAdmin.readfile(settings.MEDIA_ROOT + m.datafile.name)
...
# def home(request):
#    return render_to_response('snowball/home.html')
#
