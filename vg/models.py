...
class Measurement(models.Model):
    ...
    pressure_analyzer = models.CharField(max_length = 7, default = '1e-8', verbose_name = 'Pressure Ion Block (mbar)')
    ...
    focus_fine_1 = models.PositiveIntegerField()
    focus_fine_2 = models.PositiveIntegerField()
...
class Calibration(models.Model):
    ...
    cal_base_file_1 = models.ForeignKey('Measurement', blank = True, related_name = 'calibration_cal_base_file_1', verbose_name = 'Basefile 1 used for this cal.')
    cal_base_file_2 = models.ForeignKey('Measurement', blank = True, related_name = 'calibration_cal_base_file_2', verbose_name = 'Basefile 2 used for this cal.')
    cal_base_file_3 = models.ForeignKey('Measurement', blank = True, related_name = 'calibration_cal_base_file_3', verbose_name = 'Basefile 3 used for this cal.')
    cal_base_file_4 = models.ForeignKey('Measurement', blank = True, related_name = 'calibration_cal_base_file_4', verbose_name = 'Basefile 4 used for this cal.')
