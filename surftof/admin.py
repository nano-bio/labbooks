...
class MeasurementAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ('ToF Settings', {
            'fields': ('fil_cur', 'fil_vol', 'far_cup', 'wehnelt', 'pusher_is', 'ion_block', 'zb1r', 'zb1l', 'zb_2', 'zyl1r', 'zyl1l', 'zyl2', 'def_o', 'def_u', 'def_r', 'def_l', 'is_plate', 'pusher_tof', 'zl_grid', 'acc_grid', 'def_r_tof', 'def_l_tof', 'drift', 'reflectron', 'post_acc', 'mcp'),
        }),
    )
