...
class Measurement(models.Model):
    ...
    wehnelt = models.FloatField(verbose_name = 'Wehnelt', blank = True, null = True)
    zb1r = models.FloatField(verbose_name = 'ZB1B R', blank = True, null = True)
    zb1l = models.FloatField(verbose_name = 'ZB1A L', blank = True, null = True)
    zb_2 = models.FloatField(verbose_name = 'ZB2', blank = True, null = True)
    zyl1r = models.FloatField(verbose_name = 'Zyl1B R', blank = True, null = True)
    zyl1l = models.FloatField(verbose_name = 'Zyl1A L', blank = True, null = True)
    zyl2 = models.FloatField(verbose_name = 'Zyl 2', blank = True, null = True)
    def_o = models.FloatField(verbose_name = 'Def1B U', blank = True, null = True)
    def_u = models.FloatField(verbose_name = 'Def1A O', blank = True, null = True)
    def_r = models.FloatField(verbose_name = 'Def2B R', blank = True, null = True)
    def_l = models.FloatField(verbose_name = 'Def2A L', blank = True, null = True)
