...
class Image(models.Model):
    ...
    aux1_auto_oversampling = models.BooleanField(null=True, verbose_name='Aux1 Auto Oversampling')
    aux1_enable = models.BooleanField(null=True, verbose_name='Aux1 Enable')
    aux1_enable_storing = models.BooleanField(null=True, verbose_name='Aux1 Enable Storing')
    ...
    aux1_v_auto_oversampling = models.BooleanField(null=True, verbose_name='Aux1 V Auto Oversampling')
    aux1_v_enable = models.BooleanField(null=True, verbose_name='Aux1 V Enable')
    aux1_v_enable_storing = models.BooleanField(null=True, verbose_name='Aux1 V Enable Storing')
    ...
    aux1_z_auto_oversampling = models.BooleanField(null=True, verbose_name='Aux1 Z Auto Oversampling')
    aux1_z_enable = models.BooleanField(null=True, verbose_name='Aux1 Z Enable')
    aux1_z_enable_storing = models.BooleanField(null=True, verbose_name='Aux1 Z Enable Storing')
    ...
    aux2_auto_oversampling = models.BooleanField(null=True, verbose_name='Aux2 Auto Oversampling')
    aux2_enable = models.BooleanField(null=True, verbose_name='Aux2 Enable')
    aux2_enable_storing = models.BooleanField(null=True, verbose_name='Aux2 Enable Storing')
    ...
    aux2_t_auto_oversampling = models.BooleanField(null=True, verbose_name='Aux2 t Auto Oversampling')
    aux2_t_enable = models.BooleanField(null=True, verbose_name='Aux2 t Enable')
    aux2_t_enable_storing = models.BooleanField(null=True, verbose_name='Aux2 t Enable Storing')
    ...
    aux2_v_auto_oversampling = models.BooleanField(null=True, verbose_name='Aux2 V Auto Oversampling')
    aux2_v_enable = models.BooleanField(null=True, verbose_name='Aux2 V Enable')
    aux2_v_enable_storing = models.BooleanField(null=True, verbose_name='Aux2 V Enable Storing')
    ...
    aux2_z_auto_oversampling = models.BooleanField(null=True, verbose_name='Aux2 Z Auto Oversampling')
    aux2_z_enable = models.BooleanField(null=True, verbose_name='Aux2 Z Enable')
    aux2_z_enable_storing = models.BooleanField(null=True, verbose_name='Aux2 Z Enable Storing')
    ...
    clock1_enable = models.BooleanField(null=True, verbose_name='Clock1 Enable')
    ...
    clock2_enable = models.BooleanField(null=True, verbose_name='Clock2 Enable')
    ...
    clock3_enable = models.BooleanField(null=True, verbose_name='Clock3 Enable')
    ...
    crtcservice_enable_pfu_filter = models.BooleanField(null=True, verbose_name='CRTCService Enable PFU Filter')
    ...
    drbservice_lp_aux1_in_aa = models.BooleanField(null=True, verbose_name='DRBService Lp Aux1 In AA')
    drbservice_lp_aux2_in = models.FloatField(blank=True, null=True, verbose_name='DRBService Lp Aux2 In')
    drbservice_lp_aux2_in_aa = models.BooleanField(null=True, verbose_name='DRBService Lp Aux2 In AA')
    ...
    gapvoltagecontrol_const_voltage = models.BooleanField(null=True, verbose_name='GapVoltageControl Const Voltage')
    gapvoltagecontrol_enable_alternate_preamp_range = models.BooleanField(null=True, 
        verbose_name='GapVoltageControl Enable Alternate Preamp Range')
    gapvoltagecontrol_enable_alternate_voltage = models.BooleanField(null=True, 
    ...
    gapvoltagecontrol_tip_cond_enable_feedback_loop = models.BooleanField(null=True, 
    ...
    i_auto_oversampling = models.BooleanField(null=True, verbose_name='I Auto Oversampling')
    i_enable = models.BooleanField(null=True, verbose_name='I Enable')
    i_enable_storing = models.BooleanField(null=True, verbose_name='I Enable Storing')
    ...
    i_reg_auto_oversampling = models.BooleanField(null=True, verbose_name='I Reg Auto Oversampling')
    i_reg_enable = models.BooleanField(null=True, verbose_name='I Reg Enable')
    i_reg_enable_storing = models.BooleanField(null=True, verbose_name='I Reg Enable Storing')
    ...
    i_t_auto_oversampling = models.BooleanField(null=True, verbose_name='I t Auto Oversampling')
    i_t_enable = models.BooleanField(null=True, verbose_name='I t Enable')
    i_t_enable_storing = models.BooleanField(null=True, verbose_name='I t Enable Storing')
    ...
    i_v_auto_oversampling = models.BooleanField(null=True, verbose_name='I V Auto Oversampling')
    i_v_enable = models.BooleanField(null=True, verbose_name='I V Enable')
    i_v_enable_storing = models.BooleanField(null=True, verbose_name='I V Enable Storing')
    ...
    i_z_auto_oversampling = models.BooleanField(null=True, verbose_name='I Z Auto Oversampling')
    i_z_enable = models.BooleanField(null=True, verbose_name='I Z Enable')
    i_z_enable_storing = models.BooleanField(null=True, verbose_name='I Z Enable Storing')
    ...
    regulator_const_setpoint = models.BooleanField(null=True, verbose_name='Regulator Const Setpoint')
    ...
    regulator_enable_alternate_line_weighting = models.BooleanField(null=True, 
        verbose_name='Regulator Enable Alternate Line Weighting')
    regulator_enable_alternate_loop_gain_1_d = models.BooleanField(null=True, 
        verbose_name='Regulator Enable Alternate Loop Gain 1 D')
    regulator_enable_alternate_loop_gain_1_i = models.BooleanField(null=True, 
        verbose_name='Regulator Enable Alternate Loop Gain 1 I')
    regulator_enable_alternate_loop_gain_1_k = models.BooleanField(null=True, 
        verbose_name='Regulator Enable Alternate Loop Gain 1 K')
    regulator_enable_alternate_loop_gain_1_p = models.BooleanField(null=True, 
        verbose_name='Regulator Enable Alternate Loop Gain 1 P')
    regulator_enable_alternate_loop_gain_2_d = models.BooleanField(null=True, 
        verbose_name='Regulator Enable Alternate Loop Gain 2 D')
    regulator_enable_alternate_loop_gain_2_i = models.BooleanField(null=True, 
        verbose_name='Regulator Enable Alternate Loop Gain 2 I')
    regulator_enable_alternate_loop_gain_2_k = models.BooleanField(null=True, 
        verbose_name='Regulator Enable Alternate Loop Gain 2 K')
    regulator_enable_alternate_loop_gain_2_p = models.BooleanField(null=True, 
        verbose_name='Regulator Enable Alternate Loop Gain 2 P')
    regulator_enable_alternate_setpoint_1 = models.BooleanField(null=True, 
        verbose_name='Regulator Enable Alternate Setpoint 1')
    regulator_enable_alternate_setpoint_2 = models.BooleanField(null=True, 
        verbose_name='Regulator Enable Alternate Setpoint 2')
    regulator_enable_z_offset_slew_rate = models.BooleanField(null=True, verbose_name='Regulator Enable Z Offset Slew Rate')
    regulator_enable_z_offset_special_slew_rate = models.BooleanField(null=True, 
        verbose_name='Regulator Enable Z Offset Special Slew Rate')
    regulator_enable_z_ramp_gap_voltage = models.BooleanField(null=True, verbose_name='Regulator Enable Z Ramp Gap Voltage')
    regulator_enable_z_ramp_slew_rate = models.BooleanField(null=True, verbose_name='Regulator Enable Z Ramp Slew Rate')
    ...
    regulator_feedback_loop_enabled = models.BooleanField(null=True, verbose_name='Regulator Feedback Loop Enabled')
    ...
    spectroscopy_alternate_modulation_vext_t1t2 = models.BooleanField(null=True, 
        verbose_name='Spectroscopy Alternate Modulation VExt T1T2')
    spectroscopy_alternate_modulation_vext_t2t3 = models.BooleanField(null=True, 
        verbose_name='Spectroscopy Alternate Modulation VExt T2T3')
    spectroscopy_alternate_modulation_vmod_t1t2 = models.BooleanField(null=True, 
        verbose_name='Spectroscopy Alternate Modulation VMod T1T2')
    spectroscopy_alternate_modulation_vmod_t2t3 = models.BooleanField(null=True, 
        verbose_name='Spectroscopy Alternate Modulation VMod T2T3')
    spectroscopy_alternate_modulation_zext_t1t2 = models.BooleanField(null=True, 
        verbose_name='Spectroscopy Alternate Modulation ZExt T1T2')
    spectroscopy_alternate_modulation_zext_t2t3 = models.BooleanField(null=True, 
    ...
    spectroscopy_disable_feedback_loop = models.BooleanField(null=True, verbose_name='Spectroscopy Disable Feedback Loop')
    spectroscopy_enable_alternate_aux1_range = models.BooleanField(null=True, 
        verbose_name='Spectroscopy Enable Alternate Aux1 Range')
    spectroscopy_enable_alternate_aux2_range = models.BooleanField(null=True, 
        verbose_name='Spectroscopy Enable Alternate Aux2 Range')
    spectroscopy_enable_alternate_delay_t1_1 = models.BooleanField(null=True, 
        verbose_name='Spectroscopy Enable Alternate Delay T1 1')
    spectroscopy_enable_alternate_delay_t1_2 = models.BooleanField(null=True, 
        verbose_name='Spectroscopy Enable Alternate Delay T1 2')
    spectroscopy_enable_alternate_delay_t2_1 = models.BooleanField(null=True, 
        verbose_name='Spectroscopy Enable Alternate Delay T2 1')
    spectroscopy_enable_alternate_delay_t2_2 = models.BooleanField(null=True, 
        verbose_name='Spectroscopy Enable Alternate Delay T2 2')
    spectroscopy_enable_alternate_delay_t3_1 = models.BooleanField(null=True, 
        verbose_name='Spectroscopy Enable Alternate Delay T3 1')
    spectroscopy_enable_alternate_delay_t3_2 = models.BooleanField(null=True, 
        verbose_name='Spectroscopy Enable Alternate Delay T3 2')
    spectroscopy_enable_alternate_delay_t4_1 = models.BooleanField(null=True, 
        verbose_name='Spectroscopy Enable Alternate Delay T4 1')
    spectroscopy_enable_alternate_delay_t4_2 = models.BooleanField(null=True, 
        verbose_name='Spectroscopy Enable Alternate Delay T4 2')
    spectroscopy_enable_alternate_device_1_end = models.BooleanField(null=True, 
        verbose_name='Spectroscopy Enable Alternate Device 1 End')
    spectroscopy_enable_alternate_device_1_slew_rate = models.BooleanField(null=True, 
        verbose_name='Spectroscopy Enable Alternate Device 1 Slew Rate')
    spectroscopy_enable_alternate_device_1_start = models.BooleanField(null=True, 
        verbose_name='Spectroscopy Enable Alternate Device 1 Start')
    spectroscopy_enable_alternate_device_2_end = models.BooleanField(null=True, 
        verbose_name='Spectroscopy Enable Alternate Device 2 End')
    spectroscopy_enable_alternate_device_2_slew_rate = models.BooleanField(null=True, 
        verbose_name='Spectroscopy Enable Alternate Device 2 Slew Rate')
    spectroscopy_enable_alternate_device_2_start = models.BooleanField(null=True, 
        verbose_name='Spectroscopy Enable Alternate Device 2 Start')
    spectroscopy_enable_alternate_modulation_vext_t1t2 = models.BooleanField(null=True, 
        verbose_name='Spectroscopy Enable Alternate Modulation VExt T1T2')
    spectroscopy_enable_alternate_modulation_vext_t2t3 = models.BooleanField(null=True, 
        verbose_name='Spectroscopy Enable Alternate Modulation VExt T2T3')
    spectroscopy_enable_alternate_modulation_vmod_t1t2 = models.BooleanField(null=True, 
        verbose_name='Spectroscopy Enable Alternate Modulation VMod T1T2')
    spectroscopy_enable_alternate_modulation_vmod_t2t3 = models.BooleanField(null=True, 
        verbose_name='Spectroscopy Enable Alternate Modulation VMod T2T3')
    spectroscopy_enable_alternate_modulation_zext_t1t2 = models.BooleanField(null=True, 
        verbose_name='Spectroscopy Enable Alternate Modulation ZExt T1T2')
    spectroscopy_enable_alternate_modulation_zext_t2t3 = models.BooleanField(null=True, 
        verbose_name='Spectroscopy Enable Alternate Modulation ZExt T2T3')
    spectroscopy_enable_alternate_spectroscopy_mode = models.BooleanField(null=True, 
        verbose_name='Spectroscopy Enable Alternate Spectroscopy Mode')
    spectroscopy_enable_device_1_ramp_reversal = models.BooleanField(null=True, 
        verbose_name='Spectroscopy Enable Device 1 Ramp Reversal')
    spectroscopy_enable_device_1_ramp_step_slew_rate = models.BooleanField(null=True, 
        verbose_name='Spectroscopy Enable Device 1 Ramp Step Slew Rate')
    spectroscopy_enable_device_1_slew_rate = models.BooleanField(null=True, 
        verbose_name='Spectroscopy Enable Device 1 Slew Rate')
    spectroscopy_enable_device_2_ramp_reversal = models.BooleanField(null=True, 
        verbose_name='Spectroscopy Enable Device 2 Ramp Reversal')
    spectroscopy_enable_device_2_ramp_step_slew_rate = models.BooleanField(null=True, 
        verbose_name='Spectroscopy Enable Device 2 Ramp Step Slew Rate')
    spectroscopy_enable_device_2_slew_rate = models.BooleanField(null=True, 
        verbose_name='Spectroscopy Enable Device 2 Slew Rate')
    spectroscopy_enable_gap_preset = models.BooleanField(null=True, verbose_name='Spectroscopy Enable Gap Preset')
    spectroscopy_enable_gap_voltage_preset_slew_rate = models.BooleanField(null=True, 
        verbose_name='Spectroscopy Enable Gap Voltage Preset Slew Rate')
    spectroscopy_enable_mode_locks = models.BooleanField(null=True, verbose_name='Spectroscopy Enable Mode Locks')
    spectroscopy_enable_modulation = models.BooleanField(null=True, verbose_name='Spectroscopy Enable Modulation')
    spectroscopy_enable_status_signals = models.BooleanField(null=True, verbose_name='Spectroscopy Enable Status Signals')
    ...
    spectroscopy_modulation_vext_t1t2 = models.BooleanField(null=True, verbose_name='Spectroscopy Modulation VExt T1T2')
    spectroscopy_modulation_vext_t2t3 = models.BooleanField(null=True, verbose_name='Spectroscopy Modulation VExt T2T3')
    spectroscopy_modulation_vmod_t1t2 = models.BooleanField(null=True, verbose_name='Spectroscopy Modulation VMod T1T2')
    spectroscopy_modulation_vmod_t2t3 = models.BooleanField(null=True, verbose_name='Spectroscopy Modulation VMod T2T3')
    spectroscopy_modulation_zext_t1t2 = models.BooleanField(null=True, verbose_name='Spectroscopy Modulation ZExt T1T2')
    spectroscopy_modulation_zext_t2t3 = models.BooleanField(null=True, verbose_name='Spectroscopy Modulation ZExt T2T3')
    ...
    spectroscopy_reenable_feedback_loop = models.BooleanField(null=True, verbose_name='Spectroscopy Reenable Feedback Loop')
    ...
    stmscbservice_vgap_out_mod_select = models.BooleanField(null=True, verbose_name='STMSCBService VGap Out Mod Select')
    stmscbservice_vgap_out_select = models.FloatField(blank=True, null=True,
                                                      verbose_name='STMSCBService VGap Out Select')
    stmscbservice_vgap_select = models.BooleanField(null=True, verbose_name='STMSCBService VGap Select')
    ...
    xyscanner_auto_disable_scan = models.BooleanField(null=True, verbose_name='XYScanner Auto Disable Scan')
    ...
    xyscanner_enable_automatic_drift_compensation = models.BooleanField(null=True, 
        verbose_name='XYScanner Enable Automatic Drift Compensation')
    xyscanner_enable_drift_compensation = models.BooleanField(null=True, verbose_name='XYScanner Enable Drift Compensation')
    xyscanner_enable_scan = models.BooleanField(null=True, verbose_name='XYScanner Enable Scan')
    xyscanner_enable_subgrid = models.BooleanField(null=True, verbose_name='XYScanner Enable Subgrid')
    xyscanner_exact_match = models.BooleanField(null=True, verbose_name='XYScanner Exact Match')
    ...
    xyscanner_move_raster_time_constrained = models.BooleanField(null=True, 
    ...
    xyscanner_points_lines_constrained = models.BooleanField(null=True, verbose_name='XYScanner Points Lines Constrained')
    ...
    xyscanner_subgrid_constrained = models.BooleanField(null=True, verbose_name='XYScanner Subgrid Constrained')
    ...
    xyscanner_width_height_constrained = models.BooleanField(null=True, verbose_name='XYScanner Width Height Constrained')
    ...
    xyscanner_x_retrace = models.BooleanField(null=True, verbose_name='XYScanner X Retrace')
    ...
    xyscanner_y_retrace = models.BooleanField(null=True, verbose_name='XYScanner Y Retrace')
    z_enable = models.BooleanField(null=True, verbose_name='Z Enable')
    z_enable_storing = models.BooleanField(null=True, verbose_name='Z Enable Storing')
    ...
    z_t_auto_oversampling = models.BooleanField(null=True, verbose_name='Z t Auto Oversampling')
    z_t_enable = models.BooleanField(null=True, verbose_name='Z t Enable')
    z_t_enable_storing = models.BooleanField(null=True, verbose_name='Z t Enable Storing')
