...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Calibration.p2'
        db.delete_column(u'wippi_calibration', 'p2')

        # Deleting field 'Calibration.p1'
        db.delete_column(u'wippi_calibration', 'p1')

        # Deleting field 'Calibration.cal_base_file_4'
        db.delete_column(u'wippi_calibration', 'cal_base_file_4_id')

        # Deleting field 'Calibration.cal_base_file_3'
        db.delete_column(u'wippi_calibration', 'cal_base_file_3_id')

        # Deleting field 'Calibration.cal_base_file_2'
        db.delete_column(u'wippi_calibration', 'cal_base_file_2_id')


    def backwards(self, orm):
        # Adding field 'Calibration.p2'
        db.add_column(u'wippi_calibration', 'p2',
                      self.gf('django.db.models.fields.FloatField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'Calibration.p1'
        db.add_column(u'wippi_calibration', 'p1',
                      self.gf('django.db.models.fields.FloatField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'Calibration.cal_base_file_4'
        db.add_column(u'wippi_calibration', 'cal_base_file_4',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='calibration_cal_base_file_4', null=True, to=orm['wippi.Measurement'], blank=True),
                      keep_default=False)

        # Adding field 'Calibration.cal_base_file_3'
        db.add_column(u'wippi_calibration', 'cal_base_file_3',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='calibration_cal_base_file_3', null=True, to=orm['wippi.Measurement'], blank=True),
                      keep_default=False)

        # Adding field 'Calibration.cal_base_file_2'
        db.add_column(u'wippi_calibration', 'cal_base_file_2',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='calibration_cal_base_file_2', null=True, to=orm['wippi.Measurement'], blank=True),
                      keep_default=False)
