...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Measurement.field_axis'
        db.add_column('wippi_measurement', 'field_axis',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Measurement.field_axis'
        db.delete_column('wippi_measurement', 'field_axis')
