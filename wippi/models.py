...
class Measurement(models.Model):
    ...
    substance = models.ForeignKey(cheminventory_models.Chemical, null=True, on_delete=models.PROTECT)
...
class Calibration(models.Model):
    ...
    cal_base_file_1 = models.ForeignKey('Measurement', blank=True, null=True, related_name='calibration_cal_base_file',
                                        verbose_name='Basefile used for this cal.', on_delete=models.PROTECT)
