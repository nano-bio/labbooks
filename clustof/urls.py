...
urlpatterns = [
    ...
    url(r'^journal/new/$', clustof.views.newjournalentry),
    url(r'^journal/(\d+)/$', clustof.views.showjournalentry),
    url(r'^$', flatpageviews.flatpage, {'url': '/clustof/'}, name='clustofhome'),
