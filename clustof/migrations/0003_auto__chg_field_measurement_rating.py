...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Measurement.rating'
        db.alter_column(u'clustof_measurement', 'rating', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Measurement.rating'
        db.alter_column(u'clustof_measurement', 'rating', self.gf('django.db.models.fields.IntegerField')(default=3))
